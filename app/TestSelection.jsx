  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Select the test you would like to take</Text>
      </View>
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardSubtitle}>Check your ability to see distant objects clearly.</Text>
          <TouchableOpacity style={styles.selectButton} onPress={() => router.push('/ShortsightednessTest')}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardSubtitle}>Check your ability to see nearby objects clearly.</Text>
          <TouchableOpacity style={styles.selectButton} onPress={() => router.push('/LongsightednessTest')}>
